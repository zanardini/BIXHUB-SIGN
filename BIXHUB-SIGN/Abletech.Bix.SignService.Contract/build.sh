...
${nuget_cmd} install src/Abletech.Bix.SignService.Contract/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/Abletech.Bix.SignService.Contract.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/Abletech.Bix.SignService.Contract.dll \
-recurse:'src/Abletech.Bix.SignService.Contract/*.cs' \
-doc:bin/Abletech.Bix.SignService.Contract.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/Abletech.Bix.SignService.Contract.dll was created successfully"
fi
