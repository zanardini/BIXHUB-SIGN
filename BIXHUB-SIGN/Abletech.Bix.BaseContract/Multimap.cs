 ...
 */
#pragma warning disable CS8714 // Non è possibile usare il tipo come parametro di tipo nel tipo generico o nel metodo. Il supporto dei valori Null dell'argomento tipo non corrisponde al vincolo 'notnull'.
...
public class Multimap<TKey, TValue> : IDictionary<TKey, IList<TValue>>
{
    ...
    public void Add(TKey key, IList<TValue> value)
    {
        if (value != null && value.Count > 0)
            if (_dictionary.TryGetValue(key, out IList<TValue>? list))
                foreach (TValue? k in value) list.Add(k);
            else
            {
    ...
    {
        return TryRemove(key, out IList<TValue> _);
    }
...
#pragma warning restore CS8714 // Non è possibile usare il tipo come parametro di tipo nel tipo generico o nel metodo. Il supporto dei valori Null dell'argomento tipo non corrisponde al vincolo 'notnull'.